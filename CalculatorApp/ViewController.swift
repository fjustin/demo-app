...
//  CalculatorApp
//
//  Created by 二見大揮 on 2017/11/06.
//  Copyright © 2017年 work.momiji. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func clearCalculation(_ sender: UIButton) {
        // Cボタンが押されたら式と答えをクリアにする
        formulaLabel.text = ""
        answerLabel.text = ""
    }

    @IBAction func answerLabel(_ sender: UIButton) {
